...
function initDatatable2(){
	if($("#table-sorter").length){
	  ...
	  $('#table-sorter').DataTable( {
		  pageLength:100,"columns": [    { "width": "5%" }, 	{ "width": "10%" },	{ "width": "10%" },	{ "width": "10%" },	{ "width": "10%" },	{ "width": "10%" },	{ "width": "10%" },	{ "width": "10%" },	{ "width": "10%" },	{ "width": "10%" },    ],
		...
		$.fn.dataTable.ext.order['dom-checkbox'] = function  ( settings, col )
{
    return this.api().column( col, {order:'index'} ).nodes().map( function ( td, i ) {
		...
		$("#xdata").DataTable({
			...
			pageLength:50,
			columns: $("#xdata").data("filter"),
        initComplete: function () {
            this.api().columns().every( function (index,e) {
                var column = this;
				
				if($("#xdata tfoot th").eq(index).hasClass("filter")){
