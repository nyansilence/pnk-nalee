			...
			<li><div class="raty" data-score="<?=$row_detail['score']?>" data-big="1"></div></li>
				...
				<?php 
					if($row_detail['giacu']){
						...
						echo '<li class="new-">'._giamoi.': <span>'.myformat($row_detail['gia']).'</span><span class="percent">'._tietkiem.' <strong class="red">'.getPercent($row_detail['giacu'],$row_detail['gia']).'%</strong></li>';
					}else{
