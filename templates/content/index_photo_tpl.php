					...
					echo '<div class="owl-item-inner">';
						...
						echo '<div class="album-item">';
							echo '<a href="'.$com.'/'.$v['tenkhongdau'].'-'.$v['id'].'.html" title="'.$v['ten_'.$lang].'">
								<img class="img-responsive anim-05" src="timthumb.php?src='.$config_url."/"._upload_news_l.$v['photo'].'&w=375&h=290" alt="'.$v['ten_'.$lang].'" />
							</a>';
						echo '<div class="desc">
								<div class="inner">';
								echo '<h2><a href="'.$com.'/'.$v['tenkhongdau'].'-'.$v['id'].'.html" title="'.$v['ten_'.$lang].'">'.$v['ten_'.$lang].'</a></h2>';
